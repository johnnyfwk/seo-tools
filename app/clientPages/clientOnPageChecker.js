...
export default function ClientOnPageChecker() {
    ...
    async function handleCheckPage() {
        ...
        try {
            ...
            setPageData({
                ...
                ...data,
                scrapeDurationMs: elapsedMs,
                baseUrlEvaluation: data.baseUrlEvaluation || {},
    ...
    const base = pageData.baseUrlEvaluation;

    const sections = [
        base?.scrapeDurationMs
            ? {
                title: "Scrape Duration",
                component: <p>{formatDuration(base.scrapeDurationMs)}</p>,
            }
            : null,
        ...
        base?.enteredUrl
            ? {
                title: "URL",
                component: <Url url={base.enteredUrl} />,
            }
            : null,

        base?.enteredUrlStatusCode
            ? {
                title: "Status Code",
                component: <StatusCode
                    statusCode={base.enteredUrlStatusCode}
                    fetchError={base.enteredUrlFetchError}
                />,
            }
            : null,
        ...
        base?.robotsTxt
            ? {
                title: "Robots.txt",
                component: <RobotsTxt robotsTxt={base.robotsTxt} />,
            }
            : null
    ].filter(Boolean);
